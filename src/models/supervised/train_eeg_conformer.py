...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Train EEG-Conformer model on BCI-IV 2b dataset")
    ...
    parser.add_argument("--save", default="conformer_best.pt", help="Path to save model")
