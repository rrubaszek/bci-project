...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Train Deep ConvNet model on BCI-IV 2b dataset")
    ...
    parser.add_argument("--save", default="deep_best.pt", help="Path to save model")
